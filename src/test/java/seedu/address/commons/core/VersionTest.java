...
public class VersionTest {
    ...
    public void versionParsing_acceptableVersionString_parsedVersionCorrectly() {
        this.verifyVersionParsedCorrectly("V0.0.0ea", 0, 0, 0, true);
        this.verifyVersionParsedCorrectly("V3.10.2", 3, 10, 2, false);
        this.verifyVersionParsedCorrectly("V100.100.100ea", 100, 100, 100, true);
    }
    ...
    public void versionConstructor_correctParameter_valueAsExpected() {
        ...
        Assertions.assertEquals(10, version.getMinor());
        Assertions.assertEquals(20, version.getPatch());
        Assertions.assertEquals(true, version.isEarlyAccess());
    }
    ...
    public void versionToString_validVersion_correctStringRepresentation() {
        ...
        Assertions.assertEquals("V0.0.0ea", version.toString());

        // normal values
        version = new Version(4, 10, 5, false);
        Assertions.assertEquals("V4.10.5", version.toString());

        // big numbers
        version = new Version(100, 100, 100, true);
        Assertions.assertEquals("V100.100.100ea", version.toString());
    }
    ...
    public void versionComparable_validVersion_compareToIsCorrect() {
        ...
        Assertions.assertTrue(one.compareTo(another) == 0);
    ...
    public void versionComparable_validVersion_hashCodeIsCorrect() {
        ...
        Assertions.assertEquals(100100100, version.hashCode());

        version = new Version(10, 10, 10, false);
        Assertions.assertEquals(1010010010, version.hashCode());
    }
    ...
    public void versionComparable_validVersion_equalIsCorrect() {
        ...
        one = new Version(0, 0, 0, false);
        another = new Version(0, 0, 0, false);
        Assertions.assertTrue(one.equals(another));
    ...
    private void verifyVersionParsedCorrectly(String versionString,
        ...
        Assertions.assertEquals(new Version(major, minor, patch, isEarlyAccess), Version.fromString(versionString));
    }
}
